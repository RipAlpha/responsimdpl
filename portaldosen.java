 ...
 * @author gsina
 */
public class portaldosen extends javax.swing.JFrame {

    /**
     * Creates new form portaldosen
     */
    public portaldosen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/UTY.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(portaldosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new portaldosen().setVisible(true);
            }
        });
    }
